...
class GuestbookRepositoryIntegrationTests {
	...
	void persistsGuestbookEntry() {
		...
		GuestbookEntry entry = repository.save(new GuestbookEntry("Yoda", "May the force be with you!", "mail@mail.com"));
	...
	void findsGuestbookEntryByAuthorName() {
		...
		GuestbookEntry entry = repository.save(new GuestbookEntry("Yoda", "May the force be with you!", "mail@mail.de"));
